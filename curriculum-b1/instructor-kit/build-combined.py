...
MODULES = [
    (1, "Time, Experience & Past Habits", [("1.1", "Present Perfect vs Past Simple"), ("1.2", "Present Perfect Continuous"), ("1.3", "Used to & Would — Past Habits")]),
    (2, "If & Imagining (Conditionals)", [("2.1", "Zero & First Conditional"), ("2.2", "Second Conditional — Imagining"), ("2.3", "Wish & If Only — Regrets & Wishes")]),
    (3, "Reporting & Connecting Ideas", [("3.1", "Reported Speech — Statements"), ("3.2", "Reported Questions, Requests & Commands"), ("3.3", "Relative Clauses")]),
    (4, "Structures for Fluency", [("4.1", "The Passive Voice"), ("4.2", "Modals of Deduction & Obligation"), ("4.3", "Review Project — Opinions & Storytelling")]),
    (5, "Narrating Past & Future", [("5.1", "Past Perfect — The Earlier Past"), ("5.2", "Narrative Tenses — Telling a Story"), ("5.3", "Future Forms & Future Continuous")]),
    (6, "Precision & Detail", [("6.1", "Articles — a/an, the & zero article"), ("6.2", "Gerunds & Infinitives — Verb Patterns & Meaning"), ("6.3", "Degree & Quantity — too/enough, so/such, few/little")]),
    (7, "Real-World Communication", [("7.1", "Agreeing, Disagreeing & Discussion"), ("7.2", "Complaints & Getting Things Fixed"), ("7.3", "Work & Interviews — Describing Your Experience")]),
    (8, "Fluency & the Final Project", [("8.1", "Question Tags & Keeping a Conversation Going"), ("8.2", "Phrasal Verbs — A Practical Toolkit"), ("8.3", "Review Project — Presentation & Panel Discussion")]),
]
TITLE = "Independent English (B1 Intermediate)"

DOCS = {
    "participant-workbook": dict(
        base="student-workbook.html", role="Student Workbook",
        eyebrow="Independent English · B1 Student Workbook",
        sub="Your English notebook for the whole course. Practice the grammar, build your vocabulary, discuss real topics, and track what you can do.",
    ...
    "facilitator-guide": dict(
        ...
        eyebrow="Independent English · B1 Teacher's Guide",
        sub="The full teaching manual for a 13-week adult-education B1 class (26 classes × 90 minutes): lesson stages and timing, board plans, drilling and concept-check questions, pair-work, error correction, differentiation, and L1 watch-outs.",
    ...
    "answer-key": dict(
        ...
        eyebrow="Independent English · B1 Answer Key",
...
<title>{d['role']} — Independent English (B1)</title>
