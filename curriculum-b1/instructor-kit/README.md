# Independent English (B1 Intermediate) — Instructor Kit ("Course-in-a-Box")

A ready-to-teach package that lets an adult-education or community ESL teacher run
**Independent English (B1 Intermediate)** as a live class. The free online course
(rays-esl.netlify.app/curriculum-b1/) is the learners' homework and review — every lesson has 🔊 Listen buttons.

**Complete — all eight modules are built.** Learners finished A2 (or placed into B1); the B1 exit points to B2 *Confident English*.

| Module | Lessons | Classes | Status |
|--------|---------|---------|--------|
| 1 · Time, Experience & Past Habits | 1.1–1.3 | C1–C3 | ✅ Built |
| 2 · If & Imagining (Conditionals) | 2.1–2.3 | C4–C6 | ✅ Built |
| 3 · Reporting & Connecting Ideas | 3.1–3.3 | C7–C9 | ✅ Built |
| 4 · Structures for Fluency | 4.1–4.3 | C10–C12 | ✅ Built |
| — Progress Test 1 (Modules 1–4) | — | C13 | ✅ Built |
| 5 · Narrating Past & Future | 5.1–5.3 | C14–C16 | ✅ Built |
| 6 · Precision & Detail | 6.1–6.3 | C17–C19 | ✅ Built |
| 7 · Real-World Communication | 7.1–7.3 | C20–C22 | ✅ Built |
| 8 · Fluency & the Final Project | 8.1–8.3 | C23–C25 | ✅ Built |
...
|------|----------|----------|
| `student-workbook.{html,pdf}` | Learner | All 8 modules in clear B1 English: grammar boxes, vocabulary, exercises, dialogues, speaking tasks, "I can…" checklists, journal |
...
| `assessment/final-test.{html,pdf}` | Learner + teacher | C26 B1 exit test on all 8 modules + individual speaking interview |
| `assessment/assessment-key.{html,pdf}` | Teacher | Keys, point values, speaking/writing rubrics, who is ready for B2, how to give feedback kindly |
| `learner-welcome.{html,pdf}` | Learner | First-day handout (clear B1 English): class times, what to bring, how to use the online lessons at home |
...
`../syllabus-print.html`, `../Independent-English-B1-Syllabus-13week.pdf`.

### The shared ESL toolkit (all levels)

Level-independent tools live in `../../instructor-toolkit/` so every level's kit can reuse them:
**placement test** + key (Pre-A1 → C2), **CEFR can-do checklists** (A1 by module; A2–C2 by level — use the B1 page),
...
├─ slides/       module-1-time-experience.html … module-8-final-project.html
...
© 2026 Ray de la Paz — Independent English (B1 Intermediate) — instructor kit.
