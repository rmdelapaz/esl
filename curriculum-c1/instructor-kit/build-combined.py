...
MODULES = [
    (1, "Precision in Time & Modality", [("1.1", "Advanced Aspect — The Future in Detail"), ("1.2", "Advanced Modality — Speculation & Nuance"), ("1.3", "The Subjunctive & Unreal Uses")]),
    (2, "Conditionals, Inversion & Emphasis", [("2.1", "Advanced & Mixed Conditionals + Alternatives to \"if\""), ("2.2", "Inversion for Emphasis & Style"), ("2.3", "Cleft Sentences & Fronting for Cohesion")]),
    (3, "Cohesion, Register & Style", [("3.1", "Nominalization & Academic Style"), ("3.2", "Cohesion — Reference, Substitution & Ellipsis"), ("3.3", "Hedging, Vague Language & Diplomatic English")]),
    (4, "Lexical Range & Fluency", [("4.1", "Phrasal Verbs & Multi-word Verbs"), ("4.2", "Collocation, Idiom & Connotation"), ("4.3", "Review Project — The Advanced Communicator")]),
    (5, "Structure & Advanced Vocabulary", [("5.1", "Participle & Absolute Clauses"), ("5.2", "Advanced Prepositions & Prepositional Phrases"), ("5.3", "Academic & Formal Vocabulary")]),
    (6, "Reading & Writing at C1", [("6.1", "Critical Reading — Evaluating Arguments & Bias"), ("6.2", "Academic & Argument Writing — Structuring an Essay"), ("6.3", "Professional & Formal Writing — Reports, Emails & Applications")]),
    (7, "Listening, Speaking & Delivery", [("7.1", "Understanding Lectures & Talks — Following & Note-taking"), ("7.2", "Pronunciation & Intonation for Fluency"), ("7.3", "Seminar & Discussion Skills")]),
    (8, "Fluency, Craft & the Final Project", [("8.1", "Fluency & Spontaneity — Speaking Strategies"), ("8.2", "Precision & Concision — Editing Your English"), ("8.3", "Review Project — A Position Paper & Its Defense")]),
]
TITLE = "Advanced English (C1 Advanced)"

DOCS = {
    "participant-workbook": dict(
        base="student-workbook.html", role="Student Workbook",
        eyebrow="Advanced English · C1 Student Workbook",
        sub="Your English notebook for the whole course. Sharpen precision and style, write and argue at an advanced level, and track what you can do.",
    ...
    "facilitator-guide": dict(
        ...
        eyebrow="Advanced English · C1 Teacher's Guide",
        sub="The full teaching manual for a 13-week adult-education C1 class (26 classes × 90 minutes): lesson stages and timing, board plans, drilling and concept-check questions, pair-work, error correction, differentiation, and L1 watch-outs.",
    ...
    "answer-key": dict(
        ...
        eyebrow="Advanced English · C1 Answer Key",
...
<title>{d['role']} — Advanced English (C1)</title>
