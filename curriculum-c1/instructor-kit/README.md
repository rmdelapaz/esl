# Advanced English (C1 Advanced) — Instructor Kit ("Course-in-a-Box")

A ready-to-teach package that lets an adult-education or community ESL teacher run
**Advanced English (C1 Advanced)** as a live class. The free online course
(rays-esl.netlify.app/curriculum-c1/) is the learners' homework and review — every lesson has 🔊 Listen buttons.

**Complete — all eight modules are built.** Learners finished B2 (or placed into C1); the C1 exit points to C2 *Mastery English* (or IELTS Academic / Business English).

| Module | Lessons | Classes | Status |
|--------|---------|---------|--------|
| 1 · Precision in Time & Modality | 1.1–1.3 | C1–C3 | ✅ Built |
| 2 · Conditionals, Inversion & Emphasis | 2.1–2.3 | C4–C6 | ✅ Built |
| 3 · Cohesion, Register & Style | 3.1–3.3 | C7–C9 | ✅ Built |
| 4 · Lexical Range & Fluency | 4.1–4.3 | C10–C12 | ✅ Built |
| — Progress Test 1 (Modules 1–4) | — | C13 | ✅ Built |
| 5 · Structure & Advanced Vocabulary | 5.1–5.3 | C14–C16 | ✅ Built |
| 6 · Reading & Writing at C1 | 6.1–6.3 | C17–C19 | ✅ Built |
| 7 · Listening, Speaking & Delivery | 7.1–7.3 | C20–C22 | ✅ Built |
| 8 · Fluency, Craft & the Final Project | 8.1–8.3 | C23–C25 | ✅ Built |
...
|------|----------|----------|
| `student-workbook.{html,pdf}` | Learner | All 8 modules in C1 English — grammar for precision, writing labs, seminar skills: grammar boxes, vocabulary, exercises, dialogues, speaking tasks, "I can…" checklists, journal |
...
| `assessment/final-test.{html,pdf}` | Learner + teacher | C26 C1 exit test on all 8 modules + individual speaking interview |
| `assessment/assessment-key.{html,pdf}` | Teacher | Keys, point values, speaking/writing rubrics, who is ready for C2, how to give feedback kindly |
| `learner-welcome.{html,pdf}` | Learner | First-day handout (clear C1 English): class times, what to bring, how to use the online lessons at home |
...
`../syllabus-print.html`, `../Advanced-English-C1-Syllabus-13week.pdf`.

### The shared ESL toolkit (all levels)

Level-independent tools live in `../../instructor-toolkit/` so every level's kit can reuse them:
**placement test** + key (Pre-A1 → C2), **CEFR can-do checklists** (A1 by module; A2–C2 by level — use the C1 page),
...
├─ slides/       module-1-time-modality.html … module-8-position-paper.html
...
© 2026 Ray de la Paz — Advanced English (C1 Advanced) — instructor kit.
