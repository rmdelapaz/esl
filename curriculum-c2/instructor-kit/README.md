# Mastery English (C2 Proficiency) — Instructor Kit ("Course-in-a-Box")

A ready-to-teach package that lets an adult-education or community ESL teacher run
**Mastery English (C2 Proficiency)** as a live class. The free online course
(rays-esl.netlify.app/curriculum-c2/) is the learners' homework and review — every lesson has 🔊 Listen buttons.

**Complete — all eight modules are built.** Learners finished C1 (or placed into C2); C2 is the top of the ladder — the exit points to exam entry (CPE / IELTS 8+), professional use, or teaching/translation pathways.

| Module | Lessons | Classes | Status |
|--------|---------|---------|--------|
| 1 · The Mot Juste — Precision & Nuance | 1.1–1.3 | C1–C3 | ✅ Built |
| 2 · Reading Between the Lines — Pragmatics | 2.1–2.3 | C4–C6 | ✅ Built |
| 3 · Discourse Mastery — Structure & Cohesion | 3.1–3.3 | C7–C9 | ✅ Built |
| 4 · The Complete Communicator — Style & Rhetoric | 4.1–4.3 | C10–C12 | ✅ Built |
| — Progress Test 1 (Modules 1–4) | — | C13 | ✅ Built |
| 5 · Interpreting the Real World | 5.1–5.3 | C14–C16 | ✅ Built |
| 6 · Writing with Authority | 6.1–6.3 | C17–C19 | ✅ Built |
| 7 · Communicating Across Cultures | 7.1–7.3 | C20–C22 | ✅ Built |
| 8 · The Summit — Exams, Performance & Lifelong Command | 8.1–8.3 | C23–C25 | ✅ Built |
...
|------|----------|----------|
| `student-workbook.{html,pdf}` | Learner | All 8 modules in C2 English — nuance, pragmatics, rhetoric, writing with authority, cross-cultural communication: grammar boxes, vocabulary, exercises, dialogues, speaking tasks, "I can…" checklists, journal |
...
| `assessment/final-test.{html,pdf}` | Learner + teacher | C26 C2 exit test on all 8 modules + individual speaking interview |
| `assessment/assessment-key.{html,pdf}` | Teacher | Keys, point values, speaking/writing rubrics, who has reached C2 / is exam-ready, how to give feedback kindly |
| `learner-welcome.{html,pdf}` | Learner | First-day handout (C2 English): class times, what to bring, how to use the online lessons at home |
...
`../syllabus-print.html`, `../Mastery-English-C2-Syllabus-13week.pdf`.

### The shared ESL toolkit (all levels)

Level-independent tools live in `../../instructor-toolkit/` so every level's kit can reuse them:
**placement test** + key (Pre-A1 → C2), **CEFR can-do checklists** (A1 by module; A2–C2 by level — use the C2 page),
...
├─ slides/       module-1-mot-juste.html … module-8-masterwork.html
...
© 2026 Ray de la Paz — Mastery English (C2 Proficiency) — instructor kit.
