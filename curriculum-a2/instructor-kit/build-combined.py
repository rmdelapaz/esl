...
MODULES = [
    (1, "Talking About the Past", [("1.1", "Past Simple — Was & Were"), ("1.2", "Past Simple — Regular Verbs (-ed)"), ("1.3", "Past Simple — Irregular Verbs & Questions")]),
    (2, "Describing & Comparing", [("2.1", "Comparatives & Superlatives"), ("2.2", "Quantifiers — some, any, much, many"), ("2.3", "Adverbs of Frequency & Manner")]),
    (3, "Talking About the Future", [("3.1", "\"Going to\" — Plans & Intentions"), ("3.2", "\"Will\" & \"Might\" — Predictions & Decisions"), ("3.3", "Future Arrangements & Making Suggestions")]),
    (4, "Experiences & Advice", [("4.1", "Present Perfect — Life Experiences"), ("4.2", "Have to / Must / Should — Obligation & Advice"), ("4.3", "Review Project — Telling a Travel Story")]),
    (5, "Telling Stories", [("5.1", "Past Continuous — What Was Happening"), ("5.2", "Past Continuous vs Past Simple — when & while"), ("5.3", "used to — Life in the Past")]),
    (6, "Joining Ideas Together", [("6.1", "First Conditional — Real Possibilities"), ("6.2", "Relative Clauses — who, which, that, where"), ("6.3", "Linking Words — and, but, so, because, although")]),
    (7, "Getting Things Done", [("7.1", "Travel & Directions — Getting Around"), ("7.2", "Eating Out & Shopping — Ordering, Booking & Problems"), ("7.3", "Health & Appointments")]),
    (8, "Experiences, Plans & Review", [("8.1", "Present Perfect — for, since, just, already, yet"), ("8.2", "Verb Patterns — -ing or to-infinitive"), ("8.3", "Review Project — My Life Story & Future Plans")]),
]
TITLE = "Everyday English (A2 Elementary)"

DOCS = {
    "participant-workbook": dict(
        base="student-workbook.html", role="Student Workbook",
        eyebrow="Everyday English · A2 Student Workbook",
        sub="Your English notebook for the whole course. Learn the words, practice the grammar, tell stories, make plans, and check what you can do.",
    ...
    "facilitator-guide": dict(
        ...
        eyebrow="Everyday English · A2 Teacher's Guide",
        sub="The full teaching manual for a 13-week adult-education A2 class (26 classes × 90 minutes): lesson stages and timing, board plans, drilling and concept-check questions, pair-work, error correction, differentiation, and L1 watch-outs.",
    ...
    "answer-key": dict(
        ...
        eyebrow="Everyday English · A2 Answer Key",
...
<title>{d['role']} — Everyday English (A2)</title>
