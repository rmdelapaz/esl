# Confident English (B2 Upper-Intermediate) — Instructor Kit ("Course-in-a-Box")

A ready-to-teach package that lets an adult-education or community ESL teacher run
**Confident English (B2 Upper-Intermediate)** as a live class. The free online course
(rays-esl.netlify.app/curriculum-b2/) is the learners' homework and review — every lesson has 🔊 Listen buttons.

**Complete — all eight modules are built.** Learners finished B1 (or placed into B2); the B2 exit points to C1 *Advanced English* (or IELTS / Business English).

| Module | Lessons | Classes | Status |
|--------|---------|---------|--------|
| 1 · Narrating & Looking Back | 1.1–1.3 | C1–C3 | ✅ Built |
| 2 · Verb Patterns & Modality | 2.1–2.3 | C4–C6 | ✅ Built |
| 3 · Advanced Structures | 3.1–3.3 | C7–C9 | ✅ Built |
| 4 · Fluency & Style | 4.1–4.3 | C10–C12 | ✅ Built |
| — Progress Test 1 (Modules 1–4) | — | C13 | ✅ Built |
| 5 · Precision Grammar | 5.1–5.3 | C14–C16 | ✅ Built |
| 6 · Words & Questions | 6.1–6.3 | C17–C19 | ✅ Built |
| 7 · Communicating with Style | 7.1–7.3 | C20–C22 | ✅ Built |
...
|------|----------|----------|
| `student-workbook.{html,pdf}` | Learner | All 8 modules in natural B2 English: grammar boxes, vocabulary, exercises, dialogues, speaking tasks, "I can…" checklists, journal |
...
`../syllabus-print.html`, `../Confident-English-B2-Syllabus-13week.pdf`.

### The shared ESL toolkit (all levels)

Level-independent tools live in `../../instructor-toolkit/` so every level's kit can reuse them:
**placement test** + key (Pre-A1 → C2), **CEFR can-do checklists** (A1 by module; A2–C2 by level — use the B2 page),
...
├─ slides/       module-1-narrating.html … module-8-debate.html
...
© 2026 Ray de la Paz — Confident English (B2 Upper-Intermediate) — instructor kit.
