# English Foundations (A1 Beginner) — Instructor Kit ("Course-in-a-Box")

A ready-to-teach package that lets an adult-education or community ESL teacher run
**English Foundations (A1 Beginner)** as a live class. The free online course
(rays-esl.netlify.app/curriculum/) is the learners' homework and review — every lesson has 🔊 Listen buttons.

**Complete — all eight modules are built.**

| Module | Lessons | Classes | Status |
|--------|---------|---------|--------|
| 1 · First Words & Meeting People | 1.1–1.3 | C1–C3 | ✅ Built |
| 2 · People, Places & Things | 2.1–2.3 | C4–C6 | ✅ Built |
| 3 · Everyday Life | 3.1–3.3 | C7–C9 | ✅ Built |
| 4 · Getting Around & Doing Things | 4.1–4.3 | C10–C12 | ✅ Built |
| — Progress Test 1 (Modules 1–4) | — | C13 | ✅ Built |
| 5 · Describing the World Around Me | 5.1–5.3 | C14–C16 | ✅ Built |
| 6 · Habits, Free Time & Plans | 6.1–6.3 | C17–C19 | ✅ Built |
| 7 · Out in the World | 7.1–7.3 | C20–C22 | ✅ Built |
| 8 · Bringing It All Together | 8.1 | C23 | ✅ Built |
| — Final assessment + celebration | — | C24 | ✅ Built |

**Format:** 12 weeks · 2 classes a week · 90 minutes (24 classes, 36 hours). Mixed-first-language adults,
including learners with limited literacy or new to the Latin alphabet. Every class plan follows the same
...
|------|----------|----------|
| `student-workbook.{html,pdf}` | Learner | All 8 modules in simple A1 English: picture word lists, grammar boxes, exercises, dialogues, speaking tasks, "I can…" checklists, journal |
...
| `assessment/final-test.{html,pdf}` | Learner + teacher | C24 A1 exit test on all 8 modules + individual speaking interview |
| `assessment/assessment-key.{html,pdf}` | Teacher | Keys, point values, speaking/writing rubrics, who is ready for A2, how to give feedback kindly |
...
The 12-week **syllabus** lives one level up in the course folder: `../syllabus.html`,
`../syllabus-print.html`, `../English-Foundations-A1-Syllabus-12week.pdf`.

### The shared ESL toolkit (all levels)

Level-independent tools live in `../../instructor-toolkit/` so every level's kit can reuse them:
**placement test** + key (Pre-A1 → C2), **CEFR can-do checklists** (A1 by module; A2–C2 by level),
...
5. **Check:** the **answer key**; C13 progress test; C24 final test and interview; can-do checklists.
...
├─ slides/       module-1-first-words.html … module-8-bringing-it-together.html
...
© 2026 Ray de la Paz — English Foundations (A1 Beginner) — instructor kit.
