...
MODULES = [
    (1, "Professional Communication Foundations", [("1.1", "Business Register, Tone & First Impressions"), ("1.2", "Professional Emails & Messaging"), ("1.3", "Telephoning & Virtual Calls")]),
    (2, "Meetings & Interpersonal Skills", [("2.1", "Meetings — Participating & Chairing"), ("2.2", "Small Talk, Networking & Building Rapport"), ("2.3", "Diplomatic & Assertive Communication")]),
    (3, "Presenting, Negotiating & Persuading", [("3.1", "Presentations — Structure & Delivery"), ("3.2", "Negotiations — Language & Strategy"), ("3.3", "Pitching, Persuasion & Handling Objections")]),
    (4, "Business Writing & Career", [("4.1", "Reports, Proposals & Business Documents"), ("4.2", "CVs, Cover Letters & Job Interviews"), ("4.3", "Review Project — The Complete Business Communicator")]),
]
...
DOCS = {
    "participant-workbook": dict(
        ...
        eyebrow="Business English Student Workbook",
        sub="Your working notebook for the whole course. Build the phrases, models and habits for emails, calls, meetings, presentations, negotiations, reports and interviews, and track your progress toward your own workplace goals.",
        chips=['<span class="chip"><b>4</b> modules · 12 lessons</span>', '<span class="chip">Phrases · models · role-plays · I can…</span>', '<span class="chip">Name: ____________________</span>'],
    ...
    "facilitator-guide": dict(
        ...
        eyebrow="Business English Teacher's Guide",
        sub="The full teaching manual for an 8-week Business English class (16 classes × 90 minutes, including a needs analysis, a midpoint performance check and a two-part final assessment): lesson stages and timing, board plans, concept-check questions, drilling, role-play management, feedback on register and tone, differentiation, and L1 and cross-cultural watch-outs.",
    ...
    "answer-key": dict(
        ...
        eyebrow="Business English Answer Key",
        sub="Every workbook exercise and self-check answered, with model answers, notes on acceptable alternatives and the common learner errors to expect. Confidential teacher material.",
        chips=['<span class="chip"><b>4</b> modules</span>', '<span class="chip">Exercise, model &amp; quiz answers</span>', '<span class="chip">Confidential — do not distribute</span>'],
...
<title>{d['role']} — Business English</title>
